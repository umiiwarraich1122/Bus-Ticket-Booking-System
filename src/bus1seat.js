...
import "./bus1seat.css";
import bgImage from "./images/y1.jfif";
...
const Bus1Seat = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost/bus_booking/getSeats.php")
      .then((res) => {
  ...
  const handlePayment = async (e) => {
    ...
    try {
      ...
      await axios.post("http://localhost/bus_booking/bookSeat.php", {
    ...
    >
      ...
      <div className="seat-container">
        ...
        <div className="seats-section">
          ...
          <h2 className="route">Mandi Bahauddin → Lahore 6am</h2>
          <p className="caption">
